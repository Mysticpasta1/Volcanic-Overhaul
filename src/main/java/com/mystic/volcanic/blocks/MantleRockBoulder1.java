...
public class MantleRockBoulder1 extends MagmaBlock {
    public MantleRockBoulder1(Properties properties) {
        super(properties.requiresCorrectToolForDrops().strength(5.5F, 18.0F).lightLevel((light) -> 2));
    }
