...
public class MantleRockBolder1 extends MagmaBlock {
    public MantleRockBolder1(Properties properties) {
        super(properties.requiresCorrectToolForDrops().strength(4.0F, 30.0F).lightLevel((light) -> 8));
    }
