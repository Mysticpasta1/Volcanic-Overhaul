...
public class LowerMantleRock2 extends MagmaBlock {
    public LowerMantleRock2(Properties properties) {
        super(properties.requiresCorrectToolForDrops().strength(3.0F, 27.0F).lightLevel((light) -> 12));
    }
