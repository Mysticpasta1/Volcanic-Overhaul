...
public class LowerMantleRock1Boulder extends MagmaBlock {
    public LowerMantleRock1Boulder(Properties properties) {
        super(properties.requiresCorrectToolForDrops().strength(4.0F, 27.0F).lightLevel((light) -> 8));
    }
