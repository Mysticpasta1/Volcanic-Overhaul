...
public class MantleRock2 extends MagmaBlock {
    public MantleRock2(Properties properties) {
        super(properties.requiresCorrectToolForDrops().strength(4.5F, 18.0F).lightLevel((light) -> 5));
    }
