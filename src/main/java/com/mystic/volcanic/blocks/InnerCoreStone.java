...
public class InnerCoreStone extends MagmaBlock {
    public InnerCoreStone(Properties properties) {
        super(properties.requiresCorrectToolForDrops().strength(1.5F, 45.0F).lightLevel((light) -> 15));
    }
