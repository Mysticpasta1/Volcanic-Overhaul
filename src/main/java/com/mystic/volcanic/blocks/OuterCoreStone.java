...
public class OuterCoreStone extends MagmaBlock {
    public OuterCoreStone(Properties properties) {
        super(properties.requiresCorrectToolForDrops().strength(2.5F, 36.0F).lightLevel((light) -> 13));
    }
