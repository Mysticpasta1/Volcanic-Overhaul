...
public class LowerMantleRockBoulder extends MagmaBlock {
    public LowerMantleRockBoulder(Properties properties) {
        super(properties.requiresCorrectToolForDrops().strength(4.5F, 24.0F).lightLevel((light) -> 6));
    }
