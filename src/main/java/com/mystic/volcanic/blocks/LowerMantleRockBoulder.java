...
public class LowerMantleRockBolder extends MagmaBlock {
    public LowerMantleRockBolder(Properties properties) {
        super(properties.requiresCorrectToolForDrops().strength(6.0F, 15.0F));
    }
