...
public class LowerMantleRock1 extends MagmaBlock {
    public LowerMantleRock1(Properties properties) {
        super(properties.requiresCorrectToolForDrops().strength(3.5F, 24.0F).lightLevel((light) -> 9));
    }
